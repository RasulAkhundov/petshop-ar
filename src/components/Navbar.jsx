               ...
               <div className="col-6 col-lg-2 d-flex align-items-center justify-content-end">
                  <div className="search_login_cart_wrapper">
                     ...
                     <div className="login d-flex align-items-center">
                        {
                           userMe._id ?
                              <a className='d-flex align-items-center' href='/'><span className="material-symbols-outlined" onClick={logOut}>
                                 logout
                              </span></a>
                              :
                              <a className='d-flex align-items-center' href='/account/login'><span className="material-symbols-outlined">
                                 person
                              </span></a>
                        }
                     </div>
                     <div className="cart d-flex flex-column justify-content-center">
                        <span className="material-symbols-outlined" onClick={shoppingCartBtn}>
                           shopping_bag
                        </span>
